...
import { DayCalendarSlotsComponent, DayCalendarSlotsComponentsProps, ExportedDayCalendarProps } from '@mui/x-date-pickers/DateCalendar/DayCalendar';
import { DateCalendarClasses } from '@mui/x-date-pickers/DateCalendar/dateCalendarClasses';
import { BaseDateValidationProps, YearValidationProps, MonthValidationProps, DayValidationProps } from '@mui/x-date-pickers/internals/models/validation';
import { ExportedUseViewsOptions } from '@mui/x-date-pickers/internals/hooks/useViews';
import { DateView, TimezoneProps } from '@mui/x-date-pickers/models';
...
import { ExportedYearCalendarProps } from '@mui/x-date-pickers/YearCalendar/YearCalendar.types';
import { ExportedMonthCalendarProps } from '@mui/x-date-pickers/MonthCalendar/MonthCalendar.types';
